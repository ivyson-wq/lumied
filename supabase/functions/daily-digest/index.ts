      ...
      const htmlEmail = `
        <div style="max-width:500px;margin:0 auto;font-family:'Segoe UI',system-ui,sans-serif;">
          ...
          <div style="background:#f0ece6;padding:16px;border-radius:0 0 16px 16px;text-align:center;border:1px solid #e2dbd1;border-top:none;">
            <a href="${Deno.env.get('APP_URL') || 'https://lumied.com.br'}" style="display:inline-block;padding:10px 24px;background:#C8102E;color:#fff;text-decoration:none;border-radius:8px;font-size:14px;font-weight:600;">
              Ver mais no Portal
            </a>
